...
try:
    ...
    from apollo.ui_api.agent_intelligence_routes import router as ui_agent_intelligence_router
    from apollo.ui_api.automation_routes import router as ui_automation_router
...
if FastAPI:
    ...
    app.include_router(ui_agent_intelligence_router)
